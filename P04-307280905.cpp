...
heredar entre diversas instancias para que están unidas
...
/*
Crear cilindro y cono con arreglos din�micos vector creados en el Semestre 2023 - 1 : por Sánchez Pérez Omar Alejandro
*/
...
void CrearCono(int res, float R) {
	...
	//constantes utilizadas en los ciclos for
	int n, i;
	//cálculo del paso interno en la circunferencia y variables que almacenar�n cada coordenada de cada vértice
	GLfloat dt = 2 * PI / res, x, z, y = -0.5f;
...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Articulación base
		model = modelBase;
		model = translate(model, glm::vec3(0.0f, -1.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getbase()), glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux1 = model;
		...
		//Llanta 1 Tecla Z
		model = modelaux1;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.52f));
		...
		//articulación1 hasta articulación5 sólo son puntos de rotación o articulación, en este caso no dibujaremos esferas que los representen
		...
		//Comentar y se modifica para agregar la jerarquía:
