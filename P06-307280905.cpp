...
// average normals
	GLfloat cubo_vertices[] = {
		...
		0.5f, -0.5f,  -0.5f,	0.74f,	0.35f,		-1.0f,	0.0f,	0.0f,
		...
		-0.5f, -0.5f,  0.5f,	0.25f,	0.35f,		1.0f,	0.0f,	0.0f,
		...
		0.5f,  -0.5f,  0.5f,	0.74f,	0.34f,		0.0f,	1.0f,	0.0f,
		 0.5f,  -0.5f,  -0.5f,	0.74f,	0.025f,		0.0f,	1.0f,	0.0f,
		-0.5f, -0.5f,  -0.5f,	0.51f,	0.025f,		0.0f,	1.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado-de-numeros.tga");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		//Carro base
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -1.95f, mainWindow.getposicionCarro()));
		modelaux = model;
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
