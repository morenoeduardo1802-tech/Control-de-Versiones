...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Cofre (V) y (B)
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.97f, 0.875f));
		...
		2.- Hacer que al presionar una tecla cada pata pueda rotar un máximo de 45� "hacia adelante y hacia atr�s"
		*/
